...
using Ch30.TransactionImplementation;
using Ch30.PayrollImplementation;
...
public class PayrollTest {
    ...
    public void TestPaySingleHourlyEmployeeOnWrongDate() {
        ...
        Assert.IsNull(paycheck,
            "paycheck is available when payday is calculated on a thursday, should only be on friday");
    }
    ...
    public void TestChangeHourlyTransaction() {
        ...
        Assert.IsInstanceOfType(classification, typeof(HourlyClassification),
            "employee does not have hourly classification");
    ...
    public void TestChangeSalariedTransaction() {
        ...
        Assert.IsInstanceOfType(classification, typeof(SalariedClassification),
            "employee does not have salaried classification");
    ...
    public void TestChangeCommissionedTransaction() {
        ...
        Assert.IsInstanceOfType(classification, typeof(CommissionedClassification),
            "employee does not have commissioned classification");
    ...
    private void ValidatePaycheck(PaydayTransaction paydayTx, int empId, Date payDate, decimal grosspay,
        decimal deductions) {
        var paycheck = paydayTx.GetPaycheck(empId);
        Assert.IsNotNull(paycheck);
        Assert.AreEqual(payDate, paycheck.PayPeriodEndDate);
