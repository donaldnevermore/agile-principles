...
// TextParserTransactionSource assembly
namespace Ch30.TextParser;
...
public class TextParserTransactionSource : TransactionSource {
    ...
    private Transaction ChangeCommissioned(int empId, WordReader wordReader) {
        return _transactionFactory.MakeChangeCommissionedTransaction(empId, wordReader.NextAsDecimal(),
            wordReader.NextAsDecimal());
    }
    ...
    private Transaction AddCommissionedEmployee(int empId, string name, string address, WordReader wordReader) {
        return _transactionFactory.MakeAddCommissionedEmployeeTransaction(empId, name, address,
            wordReader.NextAsDecimal(), wordReader.NextAsDecimal());
    }
