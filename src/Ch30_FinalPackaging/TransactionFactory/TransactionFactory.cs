namespace Ch30.TransactionFactory;
...
public interface Factory {
    ...
    TransactionApplication.Transaction
        MakeServiceChargeTransaction(int memberId, CommonTypes.Date date, decimal amount);
    ...
    TransactionApplication.Transaction MakeChangeCommissionedTransaction(int empId, decimal salary,
    ...
    TransactionApplication.Transaction MakeAddCommissionedEmployeeTransaction(int empId, string name, string address,
        decimal salary, decimal commissionrate);

    TransactionApplication.Transaction MakeAddSalariedEmployeeTransaction(int empId, string name, string address,
        decimal salary);

    TransactionApplication.Transaction MakeAddHourlyEmployeeTransaction(int empId, string name, string address,
        decimal hourlyRate);
}
